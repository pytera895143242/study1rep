...
<a href = https://t.me/MovieAndSerialsBot?start={name[1:]}>🍿НАЧАТЬ СМОТРЕТЬ🍿</a>""", disable_web_page_preview=True)
...
Если сайт <b>не даёт зарегистрироваться</b> используешь эти данные для входа👇

Логин: sariev.bekir.ametovich@gmail.com 
Пороль: Bekir9110844""")
